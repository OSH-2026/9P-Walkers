...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}节点上线状态转换图\\HELLO → REGISTER → ASSIGN → RENEW → LINK STATE → ROUTE UPDATE\\（请替换为 node\_join.pdf）\vspace{2cm}}}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}帧格式与解析器状态机图\\（请替换为 link\_frame.pdf）\vspace{2cm}}}
        \caption{链路帧格式}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}控制面消息交互图\\（请替换为 mesh2\_control.pdf）\vspace{2cm}}}
        \caption{控制面消息}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}路径映射示意图\\（请替换为 path\_mapping.pdf）\vspace{2cm}}}
        \caption{统一命名空间映射}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}pending 匹配示意图\\（请替换为 pending.pdf）\vspace{2cm}}}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}路由计算示例图\\（请替换为 routing.pdf）\vspace{2cm}}}
        \caption{路由下发}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}节点端口状态与转发示意图\\（请替换为 node\_control.pdf）\vspace{2cm}}}
        \caption{STM32 控制面}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}计算任务调度示意图\\（请替换为 compute\_worker.pdf）\vspace{2cm}}}
        \caption{增量计算调度}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}多主机协作拓扑图\\（请替换为 host\_rpc.pdf）\vspace{2cm}}}
        \caption{主机间发现与协作}
      \end{figure}
    \end{column}
  \end{columns}

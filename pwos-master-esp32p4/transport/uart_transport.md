...
- 线程安全：ESP32 下使用互斥锁保护 UART 事务，防止多个任务把一条 UART 搅乱。
...
gcc -std=c11 -Wall -Wextra -DESP_PLATFORM \
  -I. -I.\pwos-master-esp32p4\transport -I.\pwos-master-esp32p4\mini9p \
  ...
  .\pwos-master-esp32p4\mini9p\mini9p_protocol.c \

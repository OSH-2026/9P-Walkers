...
/* predefined standard-library sets */
#define LUA_STDALLLIBK \
	(LUA_GLIBK | LUA_LOADLIBK | LUA_COLIBK | LUA_DBLIBK | LUA_IOLIBK | \
...
/* define LUA_DEFAULTLIBK before including this header to override it */
#if !defined(LUA_DEFAULTLIBK)
#define LUA_DEFAULTLIBK	LUA_STDEMBEDLIBK
#endif
